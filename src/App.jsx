      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/95 backdrop-blur-sm shadow-sm' : 'bg-transparent'
        ...
        <div className="max-w-4xl mx-auto px-5 py-4 flex justify-between items-center">
          <button
            ...
            className={`text-2xl md:text-3xl font-primary font-black tracking-wider transition-colors duration-300 ${isScrolled ? 'text-black' : 'text-white'
              }`}
          >
            KOEN DARRAS
          </button>
          ...
          <nav className="hidden md:flex space-x-8">
            {['MISSION', 'ADVENTURES', 'SPEAKING', 'PRESS', 'CONNECT'].map((item) => (
              <button
                ...
                className={`text-nav font-primary hover:opacity-70 transition-all duration-300 ${isScrolled ? 'text-black' : 'text-white'
                  }`}
              >
                {item}
              </button>
            ...
            <div className="flex justify-center space-x-2 mt-6">
              {[0, 1, 2, 3].map((index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-colors duration-200 ${currentMilestone === index ? 'bg-black' : 'bg-gray-300'
                    }`}
        ...
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <div className="flex justify-center items-center space-x-4 mb-6">
            <button
              ...
              className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-all duration-300 ${language === 'nl'
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-all duration-300 ${language === 'en'
                ? 'bg-white/20 text-white'
                : 'text-gray-400 hover:text-white hover:bg-white/10'
                }`}
            >
