...
export default async function handler(req, res) {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: "connect@koendarras.com",
      replyTo: req.body.email,
      subject: `New message from ${
        req.body.surname + " " + req.body.name || "koendarras.com"
      }`,
      text: `
You have received a new message from the koendarras.com.
  ...
  `,
    ...
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; border: 1px solid #eee; border-radius: 8px; padding: 20px;">
      ...
      <p><strong>From:</strong> ${
        req.body.surname + " " + req.body.name || "Anonymous"
      ...
      <p style="margin-top: 20px; font-size: 13px; color: #777;">This message was sent from the koendarras.com.</p>
    </div>
  `,
    });
